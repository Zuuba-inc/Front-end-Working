...
export class MetaDataComponent implements OnInit {
  ...
  setSettingsInitData(quiz: any) {
    ...
    this.quizConfiguration = quiz;
        ...
        if (this.quizConfiguration.quizSEOMetadata != null && this.quizConfiguration.quizSEOMetadata.seoImage != null) {
          ...
          // update seo image only when quizMediaAttached is of type image
          ...
          if (this.fileType != "video") {
            ...
            // make seo image null since video is not allowed, this should show default image preview and let user make an upload
            this.quizConfiguration.quizSEOMetadata.seoImage = this.quizConfiguration.quizSEOMetadata.seoImage ? this.quizConfiguration.quizSEOMetadata.seoImage : null;
          }
  ...
  async saveSeoData() {
    ...
    seoMetaData.quizSEOMetadata.seoImage = this.quizConfiguration.quizSEOMetadata.seoImage;
    seoMetaData.quizSEOMetadata.seoMetaDesc = this.quizConfiguration.quizSEOMetadata.seoMetaDesc;
    seoMetaData.quizSEOMetadata.seoMetaTitle = this.quizConfiguration.quizSEOMetadata.seoMetaTitle;

    if (localStorage.getItem('edit') == 'true' && localStorage.getItem('editFunnel') == 'true') {

      seoMetaData.id = this.quizConfiguration.id;
      seoMetaData.quizSEOMetadata.id = this.quizConfiguration.quizSEOMetadata.id;
    }

    let dataQuiz:any = await this.quizAPI.saveQuiz(seoMetaData);
    console.log(this.quizConfiguration.quizMediaAttached);
    var quiz = dataQuiz;
    this.quizConfiguration = quiz.data;
