...
@Component({
  selector: 'app-segmentation-rule',
  templateUrl: './segmentation-rule.component.html',
  styleUrls: ['./segmentation-rule.component.css']
})
export class SegmentationRuleComponent implements OnInit {
