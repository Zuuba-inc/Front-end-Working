...
JQSpeedTest = function(options) {
	...
	var defaults = {
		...
		testImageUrl: '/assets/images/sample_img.jpg',
	...
	function TestDownload(){
		var sendDate = (new Date()).getTime();
		 $.get(settings.testImageUrl ,function(){
...
//						console.log("Mbps: "+response)
					}
				}else{
					var response = speedGbps;
//					console.log("GBPS: "+speedGbps)
					if(settings.returnUnits == true) {
	...
	function TestUpload(){
		...
		// fetch('https://165.227.113.32:8080/getInternetSpeed')
		fetch('https://165.227.113.32:8443/getInternetSpeed')
		.then(function(response) {

			alert("inside fetch req");
	...
	// 	 $.post("/internetUploadSpeed" ,function(){
    //         var receiveDate = (new Date()).getTime();
    //         var duration = (receiveDate - sendDate) / 1000;
    //         var bitsLoaded = uploadSize * 8;
    //         var speedBps = (bitsLoaded / duration).toFixed(2);
