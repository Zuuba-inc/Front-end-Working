...
function Demo1callbackFunctionDl(value, duration){
    console.log("In demo-1:"+value)
	var str = value.substring(0,value.indexOf(" "));
	if(parseFloat(str) < 30){
		$("#dwnIcon").removeClass("fa-check-circle");
		$("#dwnIcon").addClass("fa-times-circle");
		$("#dwnIcon").css("color","red");
	}
...
function Demo1callbackFunctionUl(value, duration){
	...
	alert("inside Demo1callbackFunctionUl"+value);

	var str = value.substring(0,value.indexOf(" "));
	if(parseFloat(str) < 6){
		$("#upIcon").removeClass("fa-check-circle");
		$("#upIcon").addClass("fa-times-circle");
		$("#upIcon").css("color","red");
	}
